...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $action === 'create') {
    $stmt = $pdo->prepare('INSERT INTO clients (name, location, full_address, mobile, email, contact_person_name, contact_person_mobile, contact_person_email) VALUES (?, ?, ?, ?, ?, ?, ?, ?)');
    $stmt->execute([
...
?>
<div class="row g-3">
  <div class="col-md-5"><div class="card shadow-sm"><div class="card-body"><h5>Add Client</h5>
    <form method="post" action="?module=clients&action=create">
  ...
  <div class="col-md-7"><div class="card shadow-sm"><div class="card-body"><h5>Client List</h5>
